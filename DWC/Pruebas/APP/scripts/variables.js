...
let lugares = [
    ...
    { "nombre": "Donostia", "latitud": 43.3183, "longitud": -1.9812, "temperatura": "21ºC", "humedad": "53%", "viento": "12 m/s", "nubes": "43%", "lluvia": "300mm" },
...
let lugaresGuardados = localStorage.getItem('lugares').split(',')
